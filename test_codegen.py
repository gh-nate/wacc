...
class TestCodegen(unittest.TestCase):
    def test_convert(self):
        ...
        asm_tree = asdl.ProgramASM(
            asdl.FunctionASM(
                ...
                [
                    ...
                    asdl.MovASM(asdl.ImmASM(n), ax_reg),
                    asdl.RetASM(),
                ],
            )
        )
        ...
        asm_tree.function_definition.instructions = [
            ...
            asdl.MovASM(imm_asm, reg),
            asdl.MovASM(reg, tmp_0_stack),
        ...
        asm_tree.function_definition.instructions = [
            ...
            asdl.MovASM(tmp_0_stack, reg),
            asdl.MovASM(reg, tmp_1_stack),
            asdl.UnaryASM(not_asm, tmp_1_stack),
            asdl.MovASM(tmp_1_stack, reg),
            asdl.MovASM(reg, tmp_2_stack),
